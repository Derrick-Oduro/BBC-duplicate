        ...
        <div class="card-body p-4">
            ...
            @if(isset($posts) && count($posts) > 0)
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-6">
                            <div class="flex gap-6">
                                @if($featuredPost->image)
                                    <div class="w-32 h-32 lg:w-48 lg:h-32 flex-shrink-0">
                    ...
                    <div class="space-y-2">
                        @foreach($posts->take(-4)->reverse()->skip(1) as $post)
                            <div class="bg-white border-b border-gray-200 p-3 hover:bg-gray-50 transition-colors">
                ...
                <!-- Horizontal section below the L-shape -->
                <div class="mt-6">
                    <div class="flex space-x-4 overflow-x-auto pb-4">
                        @foreach($posts->take(6)->reverse()->skip(4) as $post)
                        <div class="bg-white border border-gray-200 rounded-lg p-3 hover:bg-gray-50 transition-colors flex-shrink-0 w-64">
                            @if($post->image)
